...
const initialNavigation = [
  ...
  { name: 'My Campaigns', href: '/profile-page?tab=My%20Campaigns', current: false },
...
}, [location, activeTab, user?.profile_pic]); 
            ...
            <Menu as="div" className="relative">
              <MenuButton className="flex items-center focus:outline-none">
                <div className="h-10 w-10 rounded-full overflow-hidden bg-gray-200 cursor-pointer">
                  <img
                    src={user?.profile_pic ? `http://localhost:5000/uploads/${user.profile_pic}?${Date.now()}` : '/default-avatar.png'}
                    alt="Profile"
